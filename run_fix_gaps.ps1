# Two-pass runner: fix gaps/tiling/lighting + capture 3 screenshots.
...
Run-Pass -method 'HospitalPackFixGaps.RunBatch' -logName 'fixgaps_apply.log'
if ($script:LastExit -ne 0) { exit $script:LastExit }
Run-Pass -method 'HospitalPackFixGaps.CaptureThree' -logName 'fixgaps_capture.log'
